    ...
    , ui(new Ui::MainWindow)
{
 ...
 //   vlayout->addWidget(round,Qt::AlignRight);
    ...
    combox->addItem(QIcon("../lwTowerDemo/image/一号塔一级.jpg"),"一号塔一级");
    combox->addItem(QIcon("../lwTowerDemo/image/一号塔二级.jpg"),"二号塔二级");
   ...
   if(m_waves>=paraconfig.size())
   {
     ...
     for (int i=0;i<paraconfig.size();i++)
     {
         for (int j=0;j<paraconfig[i].size();j++)
         {
             ...
             {
                  temp=QPixmap("../lwTowerDemo/image/怪物一.jpg");
             }
              else if(paraconfig[i][j].first=="怪物2")
              {
                   temp=QPixmap("../lwTowerDemo/image/怪物二.jpg");
              }
...
void MainWindow::getInform(int temp)
{
    ...
    if(temp==0)
    {
        Tower *tower = new Tower(m_pos, this,QPixmap("../lwTowerDemo/image/一号塔一级.jpg"));
        ...
        {
        Tower *tower = new Tower(m_pos, this,QPixmap("../lwTowerDemo/image/一号塔二级.jpg"));
        m_towersList.push_back(tower);
