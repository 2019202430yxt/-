...
MainWindow::MainWindow(QWidget *parent): QMainWindow(parent), ui(new Ui::MainWindow)
{
 ...
 //   vlayout->addWidget(round,Qt::AlignRight);
   ...
   // initWaves();
    ...
    combox->addItem(QIcon("../Towerdefence1/image/一号塔一级.jpg"),"一号塔一级");
    combox->addItem(QIcon("../Towerdefence1/image/一号塔二级.jpg"),"一号塔二级");
    combox->addItem(QIcon("../Towerdefence1/image/二号塔一级.jpg"),"二号塔一级");
    combox->addItem(QIcon("../Towerdefence1/image/二号塔二级.jpg"),"二号塔二级"); 
...
void MainWindow::paintEvent(QPaintEvent *)
{
    ...
    QPixmap cachePix("../Towerdefence1/image/Background.png");
...
//    if(m_playerHp==5)
//    {
//       result =QPixmap("../Towerdefence1/image/45kg.png");
//    }
//    else if(m_playerHp==4)
//    {
//        result =QPixmap("../Towerdefence1/image/50kg.png");
//    }
//    else if(m_playerHp==3)
//    {
//         result =QPixmap("../Towerdefence1/image/55kg.png");
//    }
//    else
//    {
//        result =QPixmap("../Towerdefence1/image/60kg.png");
//    }
   ...
   if(m_waves>paraconfig.size())
   {
     ...
     for (int i=0;i<paraconfig.size();i++) {
         for (int j=0;j<paraconfig[i].size();j++) {
             ...
             {
                  temp=QPixmap("../Towerdefence1/image/怪物一.jpg");
             }
              else if(paraconfig[i][j].first=="怪物2")
              {
                   temp=QPixmap("../Towerdefence1/image/怪物二.jpg");
              }
...
void MainWindow::getInform(int temp)
{
    ...
    if(temp==0)
    {
        Tower *tower = new Tower(m_pos, this,QPixmap("../Towerdefence1/image/一号塔一级.jpg"));
        m_towersList.push_back(tower);
           m_playrGold =m_playrGold-80;
        update();
    }
    else if(temp==1)
        {
        Tower *tower = new Tower(m_pos, this,QPixmap("../Towerdefence1/image/一号塔二级.jpg"));
        m_towersList.push_back(tower);
          m_playrGold =m_playrGold-120;
        update();
      }
    else if(temp==2)
    {
        Tower *tower = new Tower(m_pos, this,QPixmap("../Towerdefence1/image/二号塔一级.jpg"));
        m_towersList.push_back(tower);
    ...
    {
        Tower *tower = new Tower(m_pos, this,QPixmap("../Towerdefence1/image/二号塔二级.jpg"));
        m_towersList.push_back(tower);
